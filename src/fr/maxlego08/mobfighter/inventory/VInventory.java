package fr.maxlego08.mobfighter.inventory;
...
import fr.maxlego08.mobfighter.zcore.utils.builder.ItemBuilder;
...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(ZMobPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZMobPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ZMobPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZMobPlugin plugin, Player player) {
	}
