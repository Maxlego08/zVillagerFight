...
import fr.maxlego08.mobfighter.exceptions.InventoryFileNotFoundException;
import fr.maxlego08.mobfighter.exceptions.InventoryNotFoundException;
import fr.maxlego08.mobfighter.exceptions.InventorySizeException;
import fr.maxlego08.mobfighter.exceptions.NameAlreadyExistException;
import fr.maxlego08.mobfighter.loader.ButtonCollections;
...
public class InventoryLoader extends YamlUtils implements InventoryManager {
	 ...
	 * @param economy
	 */
	public InventoryLoader(ZMobPlugin plugin, IEconomy economy) {
		super(plugin);
		this.plugin = plugin;
