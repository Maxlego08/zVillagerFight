package fr.maxlego08.villager.inventory;
...
import fr.maxlego08.villager.exceptions.InventoryOpenException;
import fr.maxlego08.villager.zcore.utils.ZUtils;
import fr.maxlego08.villager.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.villager.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.villager.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected ZVillagerPlugin plugin;
	...
	protected InventoryResult preOpenInventory(ZVillagerPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ZVillagerPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ZVillagerPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ZVillagerPlugin plugin, Player player) {
	}
