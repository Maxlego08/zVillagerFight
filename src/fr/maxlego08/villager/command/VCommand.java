package fr.maxlego08.villager.command;
...
import fr.maxlego08.villager.zcore.utils.commands.Arguments;
import fr.maxlego08.villager.zcore.utils.commands.CommandType;
import fr.maxlego08.villager.zcore.utils.commands.Tab;
...
public abstract class VCommand extends Arguments {
	...
	public CommandType prePerform(ZVillagerPlugin main, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(ZVillagerPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(ZVillagerPlugin plugin, CommandSender sender2, String[] args) {
		return null;
	}
